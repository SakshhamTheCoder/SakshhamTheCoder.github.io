...
export default function Home() {
    ...
    return (
        <main className="px-8 py-24 sm:px-48 sm:py-8  flex min-h-screen flex-col items-center justify-center">
            ...
            <div className="w-1/3 flex flex-col sm:flex-row justify-evenly items-center m-4 text-center">
                <a
                    href="https://github.com/sakshhamthecoder"
                    target="_blank"
                    className="m-2 bg-primary hover:bg-[#DA003790] font-bold py-2 px-4 rounded-xl flex flex-row items-center justify-center"
                >
