...
export default function Home() {
    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-center">
            ...
            <p className="my-2 text-xl w-2/5 text-center text-tertiary">
                I am a computer science student, passionate about development, music production, and designing.
            </p>
            <div className="w-1/4 flex flex-row justify-evenly items-center m-4">
                <a
                    href="https://github.com/sakshhamthecoder"
                    target="_blank"
                    className="bg-primary hover:bg-[#DA003790] font-bold py-2 px-4 rounded-xl flex flex-row items-center justify-center"
                >
